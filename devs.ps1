...
$codeEditorsIdes = "Microsoft.VisualStudioCode", "Microsoft.VisualStudioCode.CLI", "Microsoft.VisualStudio.2022.Community", "SublimeHQ.SublimeText.4", "JetBrains.Toolbox", "lukehaas.RunJS", "Anaconda.Anaconda3", "Codeblocks.Codeblocks", "Apache.NetBeans", "ArduinoSA.CLI", "ArduinoSA.IDE.stable", "Replit.Replit", "Anysphere.Cursor" # OPTIONALS: Codux, Eclipse, JupyterNotebook, "Microsoft.VisualStudio.2022.BuildTools", "ProjectJupyter.JupyterLab"
